    ...
    <div class="text-black">
                ...
                @else
                    <div class="w-1/2">
                        <div class="pl-2">
                            <p class="p-2">{{__('Tên sản phẩm: ')}} <span id="product-name">{{ $item->name }}</span></p>
                            <p class="p-2">{{__('Giá: ')}}
                                <span id="" class="text-blue-900"> {{ number_format($item->price, 0, '', ',') }} </span>vnd
                            </p>
                            @if($item->quantity > 0)
        ...
        <div>
            <div>
                ...
                <div class="w-full">
                    <form action="{{ route('comments.store') }}" method="post">
                        ...
                        />
                        <div>
                         <textarea class="resize-none border border-blue-400 focus:outline-none rounded-lg bg-white p-5"
                                   name="content"
                                   cols="50"
                                   rows="5">
                         </textarea>
            ...
            <div>
                ...
                <div class="bg-white w-11/12 rounded-lg p-10">
                    <div>
