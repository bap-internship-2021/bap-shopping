...
<!-- component -->
    ...
    <div class="fixed flex flex-col top-0 left-0 w-64 bg-gray-900 h-full shadow-lg">
        <div class="flex items-center pl-6 h-20 border-b border-gray-800">
            <img src="{{ asset('images/admins/admin-logo.png') }}" class="border rounded-full" style="width: 80px; height: 80px">
            <div class="ml-1">
        ...
        <ul class="flex flex-col py-6 space-y-1">
            ...
            <li>
            <form     action="{{route('logout')}}" method="POST" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-700 text-gray-500 hover:text-gray-200 border-l-4 border-transparent hover:border-red-500 pr-6">
