                        ...
                        <table class="table-fixed min-w-full divide-y divide-gray-200 cursor-default">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <tr class="hover:bg-blue-50">
                                        ...
                                        <div class="flex items-center">
                                            <div class="ml-4">
                                                <div class="text-sm font-medium flex">
                                                    ...
                                                    <div>
                                                        <img src="{{ asset("admin\\images\\products\\") . \App\Models\Product::find($orderDetail->product_id)->images->first()->path }}"
                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="flex px-5 pt-2">
                                                            ...
                                                            <div class="pl-3">
                                                                <button
                                                                    class="text-blue-400 bg-white border border-blue-400 p-1 rounded w-24">Mua
                                                                    Lại</button>
                                                            </div>
                                    ...
                                    {{-- Price of a product --}} <td class="px-6 py-4 whitespace-nowrap">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        ...
                                        $orderDetail->quantity);
                                        @endphp
                                        <p class="subTotalPrice">{{ number_format($subTotal, 0, '', ',') }}</p>
                                        <span class="underline"> đ</span>
                                    </td>
                                    {{-- End subtotal price --}}
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div>
                                            <div>
                                                Tổng cộng {{ number_format($order->total_price, 0, '', ',') }} <span
