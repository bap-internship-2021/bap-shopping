...
<div class="flex justify-between">
        ...
        <div class="p-2 border border-white rounded bg-white">
            ...
            <div class="flex py-5">
                <div class="w-2/6 flex">
                    <div>
                        <img src="{{ asset('admin/images/products') . '/' . $item['image'] }}" class="rounded w-16 h-16"
                            alt="">
                    </div>
                    <div>
                ...
                <div class="w-2/6">
                    <p class="text-sm">{{ number_format($item['price'], 0, '', ',') }} <span class="underline">đ</span>
                    </p>
                </div>
                <div class="w-1/6">
                    <p>{{ $item['quantity'] }}</p>
    ...
    <div class="w-2/6 pt-10 pr-10">
        <div class="">
            <div class="border border-dashed border-blue-300 rounded p-3 bg-white">
                <div>
            ...
            <div class="border border-dashed border-blue-300 rounded p-3 bg-white">
                ...
                <div>
                    <p class="font-bold">Thông tin nhận hàng</p>
                    <p class="text-sm">Người nhận: <span class="text-base">{{ Auth::user()->name }}</span></p>
                    <p class="text-sm">Số điện thoại: <span class="text-base">{{ Auth::user()->phone }}</span></p>
                    <p class="text-sm">Địa chỉ: <span class="text-base">{{ Auth::user()->address }}</span></p>
                </div>
                @endif
                ...
                <div class="flex flex-col">
                    ...
                    <div>
                        <form action="{{ route('orders.store') }}" method="post">
                            @csrf
                            <button type="submit" class="p-1 w-full bg-blue-400 rounded hover:bg-blue-500">Đặt hàng</button>
                        </form>
                    </div>
                    ...
                    <div class="p-2"></div>
                     ...
                     <div class="text-center">
                            <a href="{{ route('carts.index') }}" class="text-center text-blue-800 underline hover:text-blue-400">Quay lại giỏ hàng</a>
                     </div>
